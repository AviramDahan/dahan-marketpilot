...
- [ ] 15-05-PLAN.md - Offline E2E tests, docs, UAT/verification, read-only QC smoke verified; command-to-order smoke still blocked until Phase 15 LEAN receiver is deployed
