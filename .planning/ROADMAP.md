...
- [x] 10-03-PLAN.md - Operations, setup, recovery, troubleshooting, and dashboard health documentation.
...
- [x] 10.1-01-PLAN.md - Runtime contract, setup registry, and orchestrator skeleton.

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 10.1-02-PLAN.md - Strategy pipeline wiring from setup evidence through scoring/ranking, risk, order intents, and reconciliation.
...
| 10.1. Close gap: runtime orchestrator for strategy-to-paper E2E flow | 1/5 | In Progress|  |
